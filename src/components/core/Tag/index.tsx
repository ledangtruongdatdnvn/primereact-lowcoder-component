import { hiddenPropertyView, jsonControl, NameConfig, NameConfigHidden, Section, StringControl, toJSONObject, UICompBuilder, withDefault, withExposingConfigs } from 'lowcoder-sdk';
