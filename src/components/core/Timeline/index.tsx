...
const exposingConfigs = [new NameConfig('staticProps'), new NameConfig('value'), new NameConfig('content'), new NameConfig('subContent'), new NameConfig('icon'), NameConfigHidden];
