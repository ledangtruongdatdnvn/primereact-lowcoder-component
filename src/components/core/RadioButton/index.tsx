...
const defRadioButtons = [{name: 'pizza', value: 'Cheese', inputId: 'pizza'}, {
  name: 'pizza2', value: 'Cheese2', inputId: 'pizza2'
}, {name: 'pizza3', value: 'Cheese3', inputId: 'pizza3'}, {name: 'pizza4', value: 'Cheese4', inputId: 'pizza4'},];
const defChecked = '';
...
let RadioButtonCompBase = (function () {
  const childrenMap = {
    ...
    onEvent: eventHandlerControl([{
      label: 'onChange', value: 'change', description: 'Triggers when Radio Button is changed.',
    },]),
  };
  ...
  return new UICompBuilder(childrenMap, (props: any) => {
    ...
    return (<div className='flex gap-4 justify-content-center align-items-center'>
      {props.radioButtons.map((item: any, index: number) => (<div key={index}>
        <RadioButton {...props.commonProps} {...item} checked={props.checked.value === item.value}
...
const exposingConfigs = [new NameConfig('commonProps'), new NameConfig('checked'), NameConfigHidden];
