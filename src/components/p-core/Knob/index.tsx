...
let KnobCompBase = (function () {
    ...
    onEvent: eventHandlerControl([
      {
        label: 'onChange',
        value: 'change',
        description: 'Triggers when Editor is changed.',
      },
    ]),
  };
  ...
  return new UICompBuilder(childrenMap, (props: any) => {
    return (
      ...
      >
        <Knob value={props.value.value} onChange={(e) => props.value.onChange(e.value)} />
      </LabelWrapper>
    );
  })
        ...
        <>
          ...
          <Section name="Description">
            <ol className="text-sm p-0 m-0 mx-4">
              <li>Static Props area should contain only static props of Primereact Editor.</li>
              <li>
                <a href="https://primereact.org/editor/" target="_blank">
                  More information
                </a>
              </li>
            </ol>
...
export default withExposingConfigs(KnobCompBase, exposingConfigs);
